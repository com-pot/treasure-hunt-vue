...
import ZebraArea from "@/minigames/ZebraFoal/ZebraArea.vue";
import ZebraNeighborRule, {NeighborPositions, NeighborRuleEvaluator} from "@/minigames/ZebraFoal/Model/ZebraNeighborRule";
